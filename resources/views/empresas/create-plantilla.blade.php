    ...
    <div class="container my-5">
        ...
        <form action="{{ route('empresa.plantilla.submit') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="url" name="enlace" id="enlace" class="form-control" value="{{ old('enlace') }}">
            </div>
                ...
                <div class="d-flex gap-3">
                    <div class="w-100">
                        ...
                        <input type="color" name="color_primario" id="color_primario"
                            class="form-control form-control-color" value="{{ old('color_primario', '#ff0000') }}" required>
                    </div>
                    <div class="w-100">
