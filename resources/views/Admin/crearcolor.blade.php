        ...
        <div class="form-container">
            ...
            <form action="{{ route('admin.colores.store') }}" method="POST">
                ...
                <div class="form__group field">
                    <input type="text" class="form__field" placeholder="Nombre del Color" id="nombre" name="nombre" required />
                    <label for="nombre" class="form__label">Nombre del Color</label>
                </div>
                <button type="submit" class="create-btn"><span>Crear Color</span></button>
            </form>
        </div>
    </main>
</body>
