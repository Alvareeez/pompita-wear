                                    ...
                                    <ul class="list-group">
                                        @foreach ($user->seguidores as $follower)
                                            <li class="list-group-item d-flex align-items-center justify-content-between"
                                                data-id="{{ $follower->id_usuario }}">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ $follower->foto_perfil ? asset($follower->foto_perfil) : asset('img/default-profile.png') }}"
                                ...
                                @else
                                    <ul class="list-group">
                                        @foreach ($user->siguiendo as $followed)
                                            <li class="list-group-item d-flex align-items-center justify-content-between"
                                                data-id="{{ $followed->id_usuario }}">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ $followed->foto_perfil ? asset($followed->foto_perfil) : asset('img/default-profile.png') }}"
                                                        class="rounded-circle me-2" width="40" height="40"
                                                        alt="Avatar">
